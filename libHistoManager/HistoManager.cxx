...
///////////////////////////////////////////////////////////
HistDefTH1D::HistDefTH1D(const char *name, const char *title, int bins, float xlow, float xhigh) {// constructor
...
///////////////////////////////////////////////////////////
HistDefTH2D::HistDefTH2D(const char *name, const char *title, int bins1, float xlow1, float xhigh1,int bins2, float xlow2, float xhigh2) {// constructor
...
///////////////////////////////////////////////////////////
HistDefTH3D::HistDefTH3D(const char *name, const char *title, int bins1, float xlow1, float xhigh1,int bins2, float xlow2, float xhigh2,
                                                              int bins3, float xlow3, float xhigh3 ) {// constructor
...
HistoManager::~HistoManager() {
  ...
  if(m_TH1DArray)  delete m_TH1DArray;
  if(m_TH2DArray)  delete m_TH2DArray;
  if(m_TH3DArray)  delete m_TH3DArray;
...
/////////////////////////////////////////////////////////////////////////////////////
//
//Add new TH1D histogram 
//
/////////////////////////////////////////////////////////////////////////////////////
void HistoManager::addTH1D(const char *name, const char *title, int bins, float xlow, float xhigh) {
  TClonesArray &a = *m_TH1DArray;
  a[th1dSize] = new (a[th1dSize]) TH1F(name, title, bins, xlow, xhigh);
  std::cout << "histoTH1F    " << name << std::endl;
  th1dSize++;
...
//
/////////////////////////////////////////////////////////////////////////////////////
void HistoManager::addTH1D(const char *name, const char *title, int binsx, const double *xbins ) {
  TClonesArray &a = *m_TH1DArray;
  a[th1dSize] = new (a[th1dSize]) TH1F(name, title, binsx, xbins);
  std::cout << "histoTH1F    " << name << std::endl;
  th1dSize++;
}
...
/////////////////////////////////////////////////////////////////////////////////////
//
//Add new TH3D histogram
//
/////////////////////////////////////////////////////////////////////////////////////
void HistoManager::addTH3D(const char *name, const char *title, int bins1, float xlow1, float xhigh1,int bins2, float xlow2, float xhigh2,
                           int bins3, float xlow3, float xhigh3) {
  TClonesArray &a = *m_TH3DArray;
  a[th3dSize] = new (a[th3dSize]) TH3D(name, title, bins1, xlow1, xhigh1, bins2, xlow2, xhigh2, bins3, xlow3, xhigh3);
  std::cout << "histoTH3D    " << name << std::endl;
  th3dSize++;
}
...
//
/////////////////////////////////////////////////////////////////////////////////////
void HistoManager::addTH3D(const char *name, const char *title, int binsx, const double *xbins , int binsy, const double *ybins, 
                           int binsz, const double *zbins) {
  TClonesArray &a = *m_TH3DArray;
  a[th3dSize] = new (a[th3dSize]) TH3D(name, title, binsx, xbins, binsy, ybins, binsz, zbins);
  std::cout << "histoTH3F    " << name << std::endl;
  th3dSize++;
}
...
/////////////////////////////////////////////////////////////////////////////////////
//
//Add new TH2D histogram
//
/////////////////////////////////////////////////////////////////////////////////////
void HistoManager::addTH2D(const char *name, const char *title, int bins1, float xlow1, float xhigh1,int bins2, float xlow2, float xhigh2) {
  TClonesArray &a = *m_TH2DArray;
  a[th2dSize] = new (a[th2dSize]) TH2D(name, title, bins1, xlow1, xhigh1, bins2, xlow2, xhigh2);
  std::cout << "histoTH2D    " << name << std::endl;
  th2dSize++;
}
...
//
/////////////////////////////////////////////////////////////////////////////////////
void HistoManager::addTH2D(const char *name, const char *title, int binsx, const double *xbins , int binsy, const double *ybins) {
  TClonesArray &a = *m_TH2DArray;
  a[th2dSize] = new (a[th2dSize]) TH2F(name, title, binsx, xbins, binsy, ybins);
  std::cout << "histoTH2D    " << name << std::endl;
  th2dSize++;
}
...
void HistoManager::CreateHistTables() {
  ...
  //-------------------------------------//
  m_TH1DArray = new TClonesArray("TH1D",5);

  //-------------------------------------//
  m_TH2DArray = new TClonesArray("TH2D",8);

  //-------------------------------------//
  m_TH3DArray = new TClonesArray("TH3D",11);
...
/////////////////////////////////////////////////////////////////////////////////////
TH1D *HistoManager::GetHistoTH1D(int x){// returns the histogram specified
  ...
  histo_d =  (TH1D*)m_TH1DArray->FindObject(name);
  if (histo_d == NULL)
    std::cout << "NULL histogram hist" <<x <<  std::endl;
...
/////////////////////////////////////////////////////////////////////////////////////
TH2D *HistoManager::GetHistoTH2D(int x){// returns the histogram specified
  ...
  histo_d =  (TH2D*)m_TH2DArray->FindObject(name);
  if (histo_d == NULL)
    std::cout << "NULL histomap " << x << std::endl;
...
/////////////////////////////////////////////////////////////////////////////////////
TH3D *HistoManager::GetHistoTH3D(int x){// returns the histogram specified
  ...
  histo_d =  (TH3D*)m_TH3DArray->FindObject(name);
  if (histo_d == NULL)
    std::cout << "NULL histomap " << x << std::endl;

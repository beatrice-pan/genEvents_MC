...
class HistDefTH1D {
 public: 
  ...
  HistDefTH1D(){}   
  HistDefTH1D(const char *name, const char *title, int bins, float xlow, float xhigh);
...
class HistDefTH2D {
 public: 
  ...
  HistDefTH2D(){} 
  HistDefTH2D(const char *name, const char *title, int bins1, float xlow1, float xhigh1,int bins2, float xlow2, float xhigh2);
...
class HistDefTH3D {
 public: 
  ...
  HistDefTH3D(){}  
  HistDefTH3D(const char *name, const char *title, int bins1, float xlow1, float xhigh1,int bins2, float xlow2, float xhigh2,
                                                   int bins3, float xlow3, float xhigh3);
...
class HistoManager: public TObject {
  ...
  TH1D     *GetHistoTH1D(int x);
  TH2D     *GetHistoTH2D(int x);
  TH3D     *GetHistoTH3D(int x);
  ...
  void addTH1D(const  char *name, const char *title, int bins,  float xlow, float xhigh);
  void addTH1D(const  char *name, const char *title, int bins, const double *xbins );
  void addTH2D(const  char *name, const char *title, int bins1, float xlow1, float xhigh1,int bins2, float xlow2, float xhigh2);
  ...
  void addTH2D(const  char *name, const char *title, int binsx, const double *xbins , int binsy, const double *ybins );
  void addTH3D(const  char *name, const char *title, int bins1, float xlow1, float xhigh1,int bins2, float xlow2, float xhigh2,
                                                     int bins3, float xlow3, float xhigh3 );
  void addTH3D(const  char *name, const char *title, int binsx, const double *xbins , int binsy, const double *ybins,
                                                     int binsz, const double *zbins );
 ...
 private:
  ...
  std::vector <HistDefTH1D>  m_histoTH1D;
  std::vector <HistDefTH2D>  m_histoTH2D;
  std::vector <HistDefTProf> m_histoTProf;
  std::vector <HistDefTH3F>  m_histoTH3F;
  std::vector <HistDefTH3D>  m_histoTH3D;

  TClonesArray      *m_TH1FArray;   //!< list of histograms TH1F;
  TClonesArray      *m_TH2FArray;   //!< list of histograms TH2F;
  TClonesArray      *m_TH1DArray;   //!< list of histograms TH1D;
  TClonesArray      *m_TH2DArray;   //!< list of histograms TH2D;
  TClonesArray      *m_TProfArray;  //!< list of histograms TProf;
  TClonesArray      *m_TH3FArray;   //!< list of histograms TH3F;
  TClonesArray      *m_TH3DArray;   //!< list of histograms TH3D;
